<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card py-3">
            <!-- <h4 class="m-0 font-weight-bold text-primary"><?= $title; ?></h4> -->
            <a href="<?= base_url('mahasiswa/index') ?>" class="btn btn-primary mb-2 mc-5 mx-10 my-7">Back to List PBL</a>
        </div>
        <div class="card py-3">
            <!-- <h4 class="m-0 font-weight-bold text-primary"><?= $title; ?></h4> -->
                ...
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    ...
                    <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">View PBL Mahasiswa</button>
                                <!-- Modal -->
