<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <form action="<?= base_url('mahasiswa/detail_pbl_mhs') ?>" method="POST">
                <!--kalau eror  -->
    ...
    <div class="card shadow mb-4">
        <!-- <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Data PBL Fakultas Kesehatan Masyarakat</h4>
        </div> -->
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary"><?= $title; ?> </h4>
            <h7 class="m-20 font-italic text-black">Data PBL Fakultas Kesehatan Masyarakat </h7>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <?php foreach ($data_pbl as $m) : ?>
                                    ...
                                    ?>
                                        <th scope="row"><?= $i; ?></th>
                                        <th><?= $m['id_pbl'] ?></th>
                                        <td> <?php echo substr($m['nama_kelompok'], 0, 200) . "...."; ?></td>
                                        <td> <?php echo substr($m['judul_pbl'], 0, 50) . "...."; ?></td>
                                        <td><?= $m['desa'] ?></td>
                                        <td><?= $m['tahun'] ?></td>
                                        <td><?= $m['keterangan'] ?></td>
                                        ...
                                        <td>
                                            <?php echo anchor(
                                                'mahasiswa/view_pbl_mhs/' . $m['id_pbl'],
...
<div class="modal fade" id="newEditModal" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newMenuModalLabel">Add New Menu</h5>
