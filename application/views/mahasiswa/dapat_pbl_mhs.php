                            ...
                            <tr>
                                <?php foreach ($as as $m) :
                                    ...
                                    ?> <th scope="row"><?= $m['id_pbl']; ?></th>
                                                ...
                                                <td><?php echo anchor('mahasiswa/view_pbl_mhs/' . $m['id_pbl'], '<div class="btn btn-info btn-sm" btn-sm data-toggle="modal" data-target="#newMenuModal1?"><li class="fa fa-eye"></li></div>') ?>
                                                </td>
